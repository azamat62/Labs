...
background = pygame.image.load("lab9/data/road.png")
coin = pygame.image.load("lab9/data/coin.png"),
coini = 0
coins = 0
...
class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab9/data/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("lab9/data/Player.png")
        self.rect = self.image.get_rect()
...
coin_x = 0
y = 0
bgsound = pygame.mixer.Sound("lab9/data/background.wav")
bgsound.play()
#Game Loop
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          bgsound.stop()
          pygame.mixer.Sound('lab9/data/crash.wav').play()
          time.sleep(0.5)
