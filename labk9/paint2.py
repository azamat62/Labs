...
class BrushButton(GameObject):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load('data/brush.png'), (50, 50))
...
class EraserButton(GameObject):
    ...
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load('data/eraser2.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class RightTriangleButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('data/right_triangle.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class SquareButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('data/square.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class EquilateralTriangleButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('data/equilateral_triangle.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class RhombusButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('data/rhombus.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class Pen(GameObject):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.image = pygame.transform.scale(pygame.image.load('data/brush.png'), (40, 40))
...
class Eraser(GameObject):
    def __init__(self, *args, **kwargs):
        self.pos = pygame.mouse.get_pos()
        self.image = pygame.transform.scale(pygame.image.load('data/eraser2.png'), (20, 20))
        self.rect = self.image.get_rect()
        self.rect.bottomleft = self.pos
