...
score_sound = pygame.mixer.Sound('lab8\sounds\lab8_data_smb_coin.wav')  # load the sound effect file
while not game_over:
...
if game_over:
    ...
    pygame.mixer.init()
    game_over_sound = pygame.mixer.Sound('lab8\sounds\lab8_data_smb_gameover.wav')
